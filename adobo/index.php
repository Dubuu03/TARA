...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Times+New+Roman:ital,wght@1,700&display=swap" />
...
<body>
    ...
    <div class="food-hero">
        <div class="food-info-container">
            <h1>ADOBO</h1>
            <p>Philippine adobo is a popular Filipino dish and cooking process in Philippine cuisine. In its base form,
                meat, seafood, or vegetables are first browned in oil, and then marinated and simmered in vinegar, salt
                and/or soy sauce, and garlic. </p>
        </div>
    </div>
    ...
    <div class="Ingredients">
        <section class="ingredients">
            <h3>INGREDIENTS</h3>
            <ul>
                <li>3 lbs whole chicken, cut into medium size pieces</li>
                <li>2 large potatoes, peeled and sliced</li>
                <li>Salt and pepper to taste</li>
                <li>2 bay leaves</li>
                <li>1 onion, sliced thinly</li>
                <li>1 whole garlic, minced</li>
                <li>¼ cup vegetable oil</li>
                <li>¼ cup soy sauce (low sodium)</li>
                <li>½ teaspoon peppercorns</li>
                <li>½ cup vinegar</li>
            </ul>
        </section>
        ...
        <div class="food-circle">
            <svg width="260" height="130" class="curved-text">
                ...
                <text class="text" text-anchor="middle">
                    <textPath class=" text__path" href="#curve" startOffset="50%">ADOBO</textPath>
                </text>
            </svg>
            <img src="./image/adobo1.png" alt="kare-kare" class="food-img">
        </div>
        <div class="spoon">
            <img class="spon" src="image\spon-removebg-preview.png" alt="">
        </div>
        <div class="leaf">
            <img class="dahon" src="image\depositphotos-111789820stockphotofreshparsleyleavesremovebgpreview-4_2x-removebg-preview.png" alt="">
            <img class="dahon1" src="image\depositphotos-111789820stockphotofreshparsleyleavesremovebgpreview-4_2x-removebg-preview.png" alt="">
            <img class="dahon2" src="image\depositphotos-111789820stockphotofreshparsleyleavesremovebgpreview-4_2x-removebg-preview.png" alt="">
            <img class="dahon3" src="image\depositphotos-111789820stockphotofreshparsleyleavesremovebgpreview-4_2x-removebg-preview.png" alt="">
        </div>
    </div>
    ...
    <div class="lower">
        <div class="Instruction">
            <section class="instructions">
                <h3>INSTRUCTIONS</h3>
                <ol>
                    <li>Marinate chicken in a mixture of onions, garlic, soy sauce, bay leaves, and peppercorns in a
                        mixing
                        bowl for 20-30 minutes before using.</li>
                    <li>Remove the chicken from the sauce, draining it, and keep the sauce for future use.</li>
                    <li>Heat a skillet over medium heat, add oil. Once hot, add sliced potatoes and cook until
                        half-cooked and
                        lightly browned. Set aside and drain on paper towels.</li>
                    </ul>
                </ol>
            </section>
