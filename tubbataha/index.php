...
<body>
    ...
    <section class="hero">
        <div class="discover-parent">
            ...
            <b class="philippines" style="font-family: impact; font-size: clamp(40px, 10vw, 100px); font-weight: 50; letter-spacing: 22px; text-align: center;">TUBBATAHA
                REEF</b>
    ...
    <section class="two-column-section">
        ...
        <div class="column">
            <h2 class="t-title" style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                THINGS TO OFFER</h2>
    ...
    <div class="f-bg">
        ...
        <div class="text-container">
            <h2 class="f-title" style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                FOODS TO ENJOY</h2>
    ...
    <section class="two-column-section">
        <div class="column">
            <h2 class="e-title" style="font-family: impact; font-size: clamp(40px, 10vw, 40px); font-weight: 50; letter-spacing: 0.3rem">
                EXPERIENCES</h2>
